...
public class ContenedoresShowcase {

	public TabPane generaPanel() {

		TabPane root = new TabPane();
		root.getTabs().addAll(new Tab("HBox", creaHBoxDemo()), new Tab("VBox", creaVBoxDemo()),
				new Tab("BorderPane", creaBorderPaneDemo()), new Tab("GridPane", creaGridPaneDemo()),
				new Tab("StackPane", creaStackPaneDemo()), new Tab("FlowPane", creaFlowPaneDemo()),
				new Tab("TilePane", creaTilePaneDemo()), new Tab("AchorPane", creaAnchorPaneDemo()),
				new Tab("SplitPane", creaSplitPaneDemo()), new Tab("ScrollPane", creaScrollPaneDemo()));
	...
	private FlowPane creaFlowPaneDemo() {
		...
		flow.getChildren().addAll(new Button("Uno"), new Button("Dos"), new Button("Tres"), new Button("Cuatro"),
				new Button("Ciiiiiiiiiiiiiinco"), new Button("Seis"));
		return flow;
	}

	private TilePane creaTilePaneDemo() {
		TilePane tile = new TilePane();
		tile.getChildren().addAll(new Button("1"), new Button("2"), new Button("3"), new Button("4"),
				new Button("Cinco"), new Button("Seis"));
		return tile;
	}
